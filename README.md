...
#### 1.[分布式系统中脑裂的问题](eraft_doc_v1/brain_spilt.md)

#### 2.[多数派投票机制](eraft_doc_v1/majority_vote.md)

#### 3.[Raft 算法概览](eraft_doc_v1/raft_basic.md)

#### 4.[eraft 中实现的 raft 接口](eraft_doc_v1/eraft_interface.md)

#### 5.[领导选举](eraft_doc_v1/eraft_leader_election.md)

#### 6.[日志复制](eraft_doc_v1/eraft_log_replication.md)

#### 7.[Raft如何保证系统崩溃时候的安全性](eraft_doc_v1/eraft_safety.md)
...
#### [分片详细设计](eraft_doc_v1/eraft_shard.md)
...
```
./cfgcli 127.0.0.1:8088 move 0,1,2,3,4 1

./cfgcli 127.0.0.1:8088 move 5,6,7,8,9 2
```

7.读写数据
```
./shardcli 127.0.0.1:8088 put testkey testvalue
./shardcli 127.0.0.1:8088 get testkey
```
